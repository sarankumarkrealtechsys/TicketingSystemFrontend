...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  searchPlaceholder = "Search tickets, projects, staff...",
  ...
  const role =
    explicitRole || (user?.role?.name === "ADMIN" ? "ADMIN" : "USER");
  ...
  return (
    <header
      className={`fixed top-0 left-0 lg:left-[260px] right-0 h-16 bg-white z-30 border-b border-[#EEEEEE] px-3 sm:px-6 flex items-center justify-between transition-all duration-200 ${className}`}
    >
